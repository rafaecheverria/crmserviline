        ...
        <div class="col-md-12">
            ...
            <div class="col-md-12"> 
                    <div class="form-group">
                      ...
                      <select id="paciente_id" name="paciente_id" class="selectpicker" data-style="select-with-transition">
            ...
            <div class="row">
                <div class="col-md-6"> 
                    <div class="form-group">
                      ...
                      <select id="doctor_id" name="doctor_id" class="selectpicker" data-style="select-with-transition">
