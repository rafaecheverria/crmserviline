                     ...
                     <div class="row sinpadding">
                        <div class="col-md-12"> 
                            <div class="form-group">
                              ...
                              <select id="region_id_up" name="region_id_up" class="selectpicker show-tick" data-dropup-auto="false" data-size="5" data-live-search="true" data-style="select-with-transition">
                        ...
                        <div class="col-md-12"> 
                            <div class="form-group">
                              ...
                              <select id="ciudad_id_up" data-live-search="true" name="ciudad_id_up" class="selectpicker show-tick" data-dropup-auto="false" data-size="5" data-style="select-with-transition">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="giro_up" name="giro_up" hidden="true">
                            </div>
                        </div>   
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="direccion_up" name="direccion_up" hidden="true">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
